      ...
      <section className="aboutus-content-container">
        <div className="aboutus-content-wrapper">
          ...
          <p className="paragraph">
            ...
            It can be challenging to find a team of car mechanics who prize
            honesty as their expertise, who strive to deliver the best customer
            experience at an affordable price. Those are PAIRS Auto mechanics
          ...
          <p className="paragraph">
            ...
            the best modern technologies to pinpoint the exact issue that is
            affecting the performance of your car. After completing the
            diagnostics, we will offer you our auto service. If you order the
